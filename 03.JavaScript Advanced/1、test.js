...
set(target, property, value, receiver) {
    target[property] = value; // 将属性添加target对象
    return true; // 表示成功设置属性
  }
});
proxy.greeting = '你好'; //在代理对象上添加属性
console.log(proxy.greeting); //你好
//证明原对象 target 没有被直接修改，所有操作都是在代理对象 proxy 上进行
console.log(target.greeting,target.hasOwnProperty('greeting'));
console.log(target);